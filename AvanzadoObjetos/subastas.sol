...
contract Subasta {
    ...
    address public highestBidder; // subastador mas alto
    uint public highestBid; //cantidad 
    bool ended; // subasta activa
    ...
    function bid() public payable {
        ...
        if(msg.value <= highestBid) revert('sorry, the bid isnot high enough!');
